...
{
    [DataContract]
    [KnownType(typeof(Galant.DataEntity.AppStatusCach))]
    [KnownType(typeof(Galant.DataEntity.Entity))]
    [KnownType(typeof(Galant.DataEntity.EventLog))]
    [KnownType(typeof(Galant.DataEntity.Package))]
    [KnownType(typeof(Galant.DataEntity.Paper))]
    [KnownType(typeof(Galant.DataEntity.PaperCheckin))]
    [KnownType(typeof(Galant.DataEntity.Product))]
